...
\begin{itemize}[topsep=2pt]
	\item \Cref{algo:start_stab,algo:end_stab}: when a conflict is detected, then the analysing
	...
	\begin{center}
		\resizebox{0.5 \textwidth}{!}{
			\begin{tabular}{lcc}
				...
				\hline
				\texttt{minisat-SymSp}   & \cellcolor{gray!30}{5653089} &      614856 \\
				\texttt{minisat-Sym}             & 5682892 &      \cellcolor{gray!30}{584868} \\
				\texttt{minisat-Sp}             & 6026840 &      612638 \\
				\hline
			\end{tabular}
		}
	\end{center}
