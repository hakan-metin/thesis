...
Over the last decades, these can handle more and more complex problems in different domains:\hakan{refaire phrase}
...
\paragraph{Compose dynamic symmetry handling}
