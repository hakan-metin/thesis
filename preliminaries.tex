...
clear from context).
To build complex formulas, different operators are used, $\neg, \lor$ and $\land$, $\cdots$ can be 
expressed by use of the basic ones.
...
divides the search space. Its objective is to find a literal that will generate a maximum of unit propagations. Intuitively, decision literals can be viewed as â€˜guessesâ€™ and propagated literals can be viewed as â€˜deductionsâ€™. 
