...
$\oplus, \cdots$ expressed using combinations of the basic ones.
...
In Boolean logic, there are some particular form of formula, called \emph{normal form}.
...
\paragraph{XOR SAT.}\cite{moore2011nature} In this particular form, each clause contains xor ($\oplus$) operator rather than or ($\lor$).
