...
solver backtracks at most one level and is called \emph{chronological backtracking}.
...
negative literal is removed from the clause that belongs to him. Then, given formula is either simplified
or leads to an inconsistency (empty clause). Literal is also added to the current assignment.
