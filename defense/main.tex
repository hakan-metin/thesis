...
\begin{tikzpicture}[overlay]
	\node[rounded, thick, minimum width=2cm, minimum height=0.5cm] at (208pt, 169pt) {};
	
	\node[rounded, thick, minimum width=3cm, minimum height=6.5cm] at (208pt, 88pt) {};
\end{tikzpicture}
\end{frame}
...
\begin{itemize}
	...
	\item International SAT competition compete each year on academic and industrial problems
\end{itemize}
...
\begin{frame}
	...
	\end{tabular}
\vfill
	\visible<4-> {\centering The set of symmetries of a formula is a group noted $G$}
\end{frame}
...
\begin{frame}
	\frametitle{Learning symmetrical clause}
