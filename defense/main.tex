...
\begin{itemize}
	...
	\visible<2>{
	\begin{itemize}
		\item[] Need to keep track of active symmetries 
	\end{itemize}
}
...
%% ----------------------------------------------------------------------------
\begin{frame}
\frametitle{CDCLSym Implementation}
\begin{itemize}
  ...
  \begin{columns}[t]
	...
	\begin{column}[c]{.5\textwidth}
		\begin{itemize}
			...
			\visible<2->{\item[] $\omega_{l_1}$} \visible<3>{$\leftarrow$ (local symmetries)}
		\end{itemize}
\end{column}
\end{columns}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \scriptsize MiniSat ESBP (Minisat with CDCLSym)
