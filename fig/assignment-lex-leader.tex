\begin{tikzpicture}
	...
	\tikzstyle{point+}=[circle,draw=red,thick,fill=red,scale=0.4]
...
\node[ellipse, draw, minimum width=4cm, minimum height=2cm] (c1) at (2.5,0){};
	...
	\foreach \p in {1,...,100}
	{
		\fill (4*rand,2*rand) circle (0.08);
	}
\end{scope}
...
\node[circle, fill=red, draw=red, line width=0.5mm, scale=0.3] (le) at (7, -2) {};
